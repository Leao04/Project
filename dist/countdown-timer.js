        ...
        return function (d, y, v, h) {
          for (
            var g,
              ...
              O = 0,
              A = h || u,
              j = e ? A(d, x) : n ? A(d, 0) : void 0; x > O; O++
          ) {
      ...
      r({
        ...
        slice(t, e) {
          ...
          if (
            ...
            return h.call(l, d, y)
          for (
            r = new(void 0 === n ? Array : n)(g(y - d, 0)), f = 0; d < y; d++, f++
          )
            d in l && s(r, f, l[d])
          return (r.length = f), r
        },
    ...
    function (t, e, n) {
      ...
      r({
        ...
        getOwnPropertyDescriptors(t) {
          for (
            var e, n, r = a(t), o = u.f, s = i(r), f = {}, l = 0; s.length > l;
      ...
      function r(t, e) {
        return (
          ...
          (function (t, e) {
            ...
            try {
              for (
                var a, u = t[Symbol.iterator](); !(r = (a = u.next()).done) &&
