    ...
    <div class="conteudomash">
      ...
      <div class="nintendoimg2">
        <img
          ...
          alt="Imagen do pessonagem Steve"
        />
      </div>
      <div class="mash">
        <p>Curiosidades do jogo de luta.</p>
      </div>
      <div class="conteudomash">
        <p>
          Steve se move de maneira semelhante aos seus movimentos em Minecraft:
          um pouco duros, com animações semelhantes para andar, pular e atacar.
          Sua espada não parece ter um grande alcance em comparação aos outros
          lutadores. Apesar disso, há uma habilidade interessante que parece
          torná-lo um personagem único: sua capacidade de colocar blocos em
          tempo real nas fases. Durante a transmissão, três jogadores utilizam
          Steve para criar uma casa de blocos ao redor de um Pichu, o que indica
